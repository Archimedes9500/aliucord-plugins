...
public class ReflectUtilsTest extends Plugin{
    ...
    public void start(Context context) throws Throwable{
        ...
        noReflection();
        logger.debug("noReflection: "+((System.nanoTime()-time)/iterations));
        time = System.nanoTime();
        noCache();
        logger.debug("noCache: "+((System.nanoTime()-time)/iterations));
        time = System.nanoTime();
        withCache();
        logger.debug("withCache: "+((System.nanoTime()-time)/iterations));
        time = System.nanoTime();
        oldReflectUtils();
        logger.debug("oldReflectUtils: "+((System.nanoTime()-time)/iterations));
        time = System.nanoTime();
        oldReflectUtilsWithCache();
        logger.debug("oldReflectUtilsWithCache: "+((System.nanoTime()-time)/iterations));
        time = System.nanoTime();
        newReflectUtils();
        logger.debug("newReflectUtils: "+((System.nanoTime()-time)/iterations));
