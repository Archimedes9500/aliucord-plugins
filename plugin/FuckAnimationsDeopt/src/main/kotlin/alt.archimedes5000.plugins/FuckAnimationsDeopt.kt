...
class FuckAnimationsDeopt: Plugin(){
	...
	override fun start(pluginContext: Context){
		...
		originalState = settings.getBool("originalState", store.isReducedMotionEnabled());
		if(!settings.exists("originalState")){
		...
		patcher.before<StoreUserSettings>(
			...
			Boolean::class.java,
			arrayOf<java.lang.reflect.Executable>(
