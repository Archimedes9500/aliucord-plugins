...
class ReplyReferencesFix:Plugin(){
	...
	override fun start(pluginContext:Context){
		...
		fun clone(context:Context, original:View):View{
			...
			clone.setClickable(original.getClickable());
			clone.setContentDescription(original.getContentDescription());
			clone.setDrawingCacheQuality(original.getDrawingCacheQuality());
			clone.setDuplicateParentState(original.getDuplicateParentState());
			clone.setId(original.getId());
			clone.setRequiresFadingEdge(original.getRequiresFadingEdge());
			clone.setFadeScrollbars(original.getFadeScrollbars());
			clone.setFadingEdgeLength(original.getFadingEdgeLength());
			clone.setFilterTouchesWhenObscured(original.getFilterTouchesWhenObscured());
			clone.setFitsSystemWindows(original.getFitsSystemWindows());
			clone.setIsScrollContainer(original.getIsScrollContainer());
			clone.setFocusable(original.getFocusable());
			clone.setFocusableInTouchMode(original.getFocusableInTouchMode());
			clone.setHapticFeedbackEnabled(original.getHapticFeedbackEnabled());
			clone.setKeepScreenOn(original.getKeepScreenOn());
			clone.setLayerType(original.getLayerType());
			clone.setLayoutDirection(original.getLayoutDirection());
			clone.setLongClickable(original.getLongClickable());
			clone.setMinHeight(original.getMinHeight());
			clone.setMinWidth(original.getMinWidth());
			clone.setNextFocusDown(original.getNextFocusDown());
			clone.setNextFocusLeft(original.getNextFocusLeft());
			clone.setNextFocusRight(original.getNextFocusRight());
			clone.setNextFocusUp(original.getNextFocusUp());
			clone.setOnClick(original.getOnClick());
			clone.setPadding(original.getPadding());
			clone.setPaddingBottom(original.getPaddingBottom());
			clone.setPaddingLeft(original.getPaddingLeft());
			clone.setPaddingRight(original.getPaddingRight());
			clone.setPaddingTop(original.getPaddingTop());
			clone.setPaddingStart(original.getPaddingStart());
			clone.setPaddingEnd(original.getPaddingEnd());
			clone.setSaveEnabled(original.getSaveEnabled());
			clone.setRotation(original.getRotation());
			clone.setRotationX(original.getRotationX());
			clone.setRotationY(original.getRotationY());
			clone.setScaleX(original.getScaleX());
			clone.setScaleY(original.getScaleY());
			clone.setScrollX(original.getScrollX());
			clone.setScrollY(original.getScrollY());
			clone.setScrollbarSize(original.getScrollbarSize());
			clone.setScrollbarStyle(original.getScrollbarStyle());
			clone.setScrollbars(original.getScrollbars());
			clone.setScrollbarDefaultDelayBeforeFade(original.getScrollbarDefaultDelayBeforeFade());
			clone.setScrollbarFadeDuration(original.getScrollbarFadeDuration());
			clone.setScrollbarTrackHorizontal(original.getScrollbarTrackHorizontal());
			clone.setScrollbarThumbHorizontal(original.getScrollbarThumbHorizontal());
			clone.setScrollbarThumbVertical(original.getScrollbarThumbVertical());
			clone.setScrollbarTrackVertical(original.getScrollbarTrackVertical());
			clone.setScrollbarAlwaysDrawHorizontalTrack(original.getScrollbarAlwaysDrawHorizontalTrack());
			clone.setScrollbarAlwaysDrawVerticalTrack(original.getScrollbarAlwaysDrawVerticalTrack());
			clone.setSoundEffectsEnabled(original.getSoundEffectsEnabled());
			clone.setTag(original.getTag());
			clone.setTextAlignment(original.getTextAlignment());
			clone.setTextDirection(original.getTextDirection());
			clone.setTransformPivotX(original.getTransformPivotX());
			clone.setTransformPivotY(original.getTransformPivotY());
			clone.setTranslationX(original.getTranslationX());
			clone.setTranslationY(original.getTranslationY());
			clone.setVisibility(original.getVisibility());
		
			if(original is ViewGroup){
				clone = clone as ViewGroup;
		
				clone.setClipChildren(original.getClipChildren());
				clone.setClipToPadding(original.getClipToPadding());
				clone.setLayoutAnimation(original.getLayoutAnimation());
				clone.setAnimationCache(original.getAnimationCache());
				clone.setPersistentDrawingCache(original.getPersistentDrawingCache());
				clone.setAlwaysDrawnWithCache(original.getAlwaysDrawnWithCache());
				clone.setAddStatesFromChildren(original.getAddStatesFromChildren());
				clone.setDescendantFocusability(original.getDescendantFocusability());
				clone.setAnimateLayoutChanges(original.getAnimateLayoutChanges());
			}
		
			if(original is LinearLayout){
				clone = clone as LinearLayout;
		
				clone.setBaselineAligned(original.getBaselineAligned());
				clone.setBaselineAlignedChildIndex(original.getBaselineAlignedChildIndex());
				clone.setGravity(original.getGravity());
				clone.setMeasureWithLargestChild(original.getMeasureWithLargestChild());
				clone.setOrientation(original.getOrientation());
				clone.setWeightSum(original.getWeightSum());
			}
