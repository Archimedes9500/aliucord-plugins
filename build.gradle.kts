...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/Archimedes9500/aliucord-plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/Archimedes9500/aliucord-plugins/builds/%s.zip")
    }
